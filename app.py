"""\napp.py — EHV Transformer Under-Impedance (Backup Impedance / Mho) Protection\nSelf-contained single file: calculations + UI inlined. No external imports.\nIEC 60255-121:2014 & CEA Protection Guidelines 2010\n"""\n\nimport streamlit as st
import math
import plotly.graph_objects as go

# ══════════════════════════════════════════════════════════════════════════════
# CALCULATIONS (inlined — no external module import needed)
# ══════════════════════════════════════════════════════════════════════════════
